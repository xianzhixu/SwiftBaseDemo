...
print("Hello, World!")
//1. ARC(Auto Reference Counteting)自动引用计数:swift会通过ARC来自动管理内存.当类的实例不再被使用的时候,会自动释放其占用的内存
...
var eleement1:Element? = Element(name:"Alex",text:"Hello")
print(eleement1!.group())
eleement1 = nil
